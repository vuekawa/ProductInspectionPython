...
class MainApplication(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        group1 = tk.LabelFrame(parent, text = "Control Robot", padx = 10, pady = 10, width = 300, height = 380)
        ...
        group2 = tk.LabelFrame(parent, text = "Data Acquisition", padx = 10, pady = 10, width = 300, height = 150)
